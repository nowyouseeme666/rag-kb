---
created: 2026-06-05T12:01:17 (UTC +08:00)
tags: []
source: https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E9%94%99%E8%AF%AF%E5%A4%84%E7%90%86%E7%AD%96%E7%95%A5-error-handling-strategies
author: 
---

# 结构化输出 | LangChain 中文文档

> ## Excerpt
> 结构化输出允许 智能体（agents） 以特定的、可预测的格式返回数据。这样，您无需解析自然语言响应，即可获得 JSON 对象、Pydantic 模型 或 数据类（dataclasses） 形式的结构化数据，供您的应用程序直接使用。 LangChain 的 会自动处理结构化输出。用户设置所需的结构化输出 模式（schema），当模型生成结构化数据时，它...

---
1.  [LangChain 中文教程](https://langchain-doc.cn/)
2.  [V1](https://langchain-doc.cn/v1/)
3.  [Python](https://langchain-doc.cn/v1/python/)
4.  [Langchain](https://langchain-doc.cn/v1/python/langchain/)
5.  [结构化输出](https://langchain-doc.cn/v1/python/langchain/structured-output.html)
...
## [响应格式 (Response Format)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E5%93%8D%E5%BA%94%E6%A0%BC%E5%BC%8F-response-format)
...
## [提供商策略 (Provider strategy)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E6%8F%90%E4%BE%9B%E5%95%86%E7%AD%96%E7%95%A5-provider-strategy)
...
## [工具调用策略 (Tool calling strategy)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E5%B7%A5%E5%85%B7%E8%B0%83%E7%94%A8%E7%AD%96%E7%95%A5-tool-calling-strategy)
...
_(为简洁起见，省略了 Dataclass、TypedDict、JSON Schema 和 Union Types 的 ToolStrategy 示例，它们的结构与 Provider Strategy 类似。)_

### [自定义工具消息内容 (Custom tool message content)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%B7%A5%E5%85%B7%E6%B6%88%E6%81%AF%E5%86%85%E5%AE%B9-custom-tool-message-content)
...
如果没有 `tool_message_content`，最终的 [`ToolMessage`](https://langchain-doc.cn/v1/python/langchain/%5Bhttps:/reference.langchain.com/python/langchain/messages/#langchain.messages.ToolMessage%5D(https://reference.langchain.com/python/langchain/messages/#langchain.messages.ToolMessage)) 将是：
...
### [错误处理 (Error handling)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E9%94%99%E8%AF%AF%E5%A4%84%E7%90%86-error-handling)

模型在通过工具调用生成结构化输出时可能会出错。LangChain 提供了智能的重试机制来自动处理这些错误。

#### [多个结构化输出错误 (Multiple structured outputs error)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E5%A4%9A%E4%B8%AA%E7%BB%93%E6%9E%84%E5%8C%96%E8%BE%93%E5%87%BA%E9%94%99%E8%AF%AF-multiple-structured-outputs-error)

当模型错误地调用了多个结构化输出工具时，智能体会通过 [`ToolMessage`](https://langchain-doc.cn/v1/python/langchain/%5Bhttps:/reference.langchain.com/python/langchain/messages/#langchain.messages.ToolMessage%5D(https://reference.langchain.com/python/langchain/messages/#langchain.messages.ToolMessage)) 提供错误反馈，并提示模型重试：
...
#### [模式验证错误 (Schema validation error)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E6%A8%A1%E5%BC%8F%E9%AA%8C%E8%AF%81%E9%94%99%E8%AF%AF-schema-validation-error)
...
#### [错误处理策略 (Error handling strategies)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#%E9%94%99%E8%AF%AF%E5%A4%84%E7%90%86%E7%AD%96%E7%95%A5-error-handling-strategies)
